...
```{r read data into r, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r create city map 11, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r create city map 12, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r create zone year facet map, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r create nbh year facet map, message=FALSE, warning=FALSE, cache=TRUE}
city_map_facets <-  ggmap(get_map("North Oakland, Pittsburgh, PA", 
                                  zoom = 12,
                                  maptype = "toner-lite", 
                                  source = "stamen"))
