...
simple_network %>% 
  mutate(from_station_name = factor(from_station_name, levels = x_axis),
         to_station_name = factor(to_station_name, levels = y_axis)) %>% 
  ggplot(aes(from_station_name, to_station_name, fill = n)) +
  geom_tile() +
  theme_bw() +
  coord_equal() +
  scale_fill_viridis() +
