...
The data is currently arrange "long", which means that the data that shows where a trip started and ended are in the same column (station_name_type)
...
#create vector for ordering the xyaxis  
...
#talk about people driving to bike stations near trails, going for a ride, and then returning to the same station
